...
$stmt = $conectar->prepare('SELECT category.name_cat, posts.title, posts.image,posts.id, posts.description, posts.data FROM category INNER JOIN posts ON category.id_cat = posts.idCategory WHERE id_cat = :id;');
